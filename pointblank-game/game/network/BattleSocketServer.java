...
{
	protected static final BattleSocketServer INSTANCE = new BattleSocketServer();
	protected SocketComplement sc;
	public BattleSocketServer()
	{
	}
	public static BattleSocketServer gI()
	{
		return INSTANCE;
	}
	public BattleSocketServer configure(SocketComplement sc) throws Exception
	{
		this.sc = sc;
