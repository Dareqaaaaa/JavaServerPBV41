...
public class PLAYER_CONFIG_UPDATE_REQ extends game.network.protocol.GamePacketREQ
{
	protected Player player;
	protected int type;
	public PLAYER_CONFIG_UPDATE_REQ(int opcode) 
	{
		super(opcode);
	}
	@Override
	...
	public void KEYBOARD(int length)
	{
		if (buf.readableBytes() == length)
		{
			...
			db.executeQuery("UPDATE jogador_teclado SET k_valor5='" + player.keyboard.k_valor5 + "' WHERE player_id='" + client.pId + "'");
		}
	}
