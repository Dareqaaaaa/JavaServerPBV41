...
public class INVENTORY_LEAVE_REQ extends game.network.protocol.GamePacketREQ
{
	protected int type;
	public INVENTORY_LEAVE_REQ(int opcode)
	{
		super(opcode);
	}
	@Override
	...
	public void runImpl()
	{
		...
		sendPacket(new INVENTORY_LEAVE_ACK(type));
	}
}